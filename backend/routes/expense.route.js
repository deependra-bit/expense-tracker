...
import { addExpense, getAllExpense, markAsDoneOrUndone, reomveExpense, updateExpense } from "../controllers/expense.controller.js";
...
router.route("/remove/:id").delete(isAuthenticated,reomveExpense);
