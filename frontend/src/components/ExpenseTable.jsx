    ...
    <Table>
        ...
        {localExpense.length===0?<span>Add Your first Expense</span>: localExpense?.map((expense) => (
          <TableRow key={expense._id}>
            ...
            <TableCell className="text-right">
                ...
                {/* <Button size="icon" className="rounded-full border text-blue-600 border-blue-600 hover:border-transparent" variant="outline"><Edit2 className="h-4 w-4"/></Button> */}
      ...
      <TableFooter>
        <TableRow>
          ...
          <TableCell className="text-right text-xl font-bold">{totalAmount} ₹</TableCell>
        </TableRow>
      </TableFooter>
    </Table>
  )
